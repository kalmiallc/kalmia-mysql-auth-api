...
export enum AuthValidatorErrorCode {
  ...
  USER_PASSWORD_NOT_PRESENT = 100_422004,
  ...
  ROLE_NAME_ALREADY_TAKEN = 100_422018,
  USER_PIN_NOT_CORRECT_LENGTH = 100_422019,
  USER_PIN_ALREADY_TAKEN = 100_422020,
  ROLE_PERMISSION_READ_LEVEL_NOT_VALID = 100_422021,
  ROLE_PERMISSION_WRITE_LEVEL_NOT_VALID = 100_422022,
  ROLE_PERMISSION_EXECUTE_LEVEL_NOT_VALID = 100_422023
}
